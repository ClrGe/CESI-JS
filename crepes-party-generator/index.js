...
function addCode() {
    ...
    ing3Div.innerText = "Il faut " + Math.round(lait) + " L de lait";
    ing4Div.innerText = "Il faut " + Math.ceil(sucre) + " c.a.s de sucre";
    ing5Div.innerText = "Il faut " + Math.ceil(beurre) + " g de beurre";
    ing6Div.innerText = "";
    ...
    console.log("Il faut " + lait + " L de lait ");
    console.log("Il faut " + sucre + " c.a.s de sucre");
...
function addCode() {
    const   ing1Div = document.getElementById('ingredient01'),
            ...
            ing4Div.innerText = "Il faut " + sucre + " c.a.s de sucre";                ing5Div.innerText = "Il faut " + beurre + " g de beurre";
            ing6Div.innerText = "";
